...
Reads a reference from file S."""
    ...
    elif c == "s": return s.read(int(s.readline())) # str in Python 2
    elif c == "u": return s.read(int(s.readline())).decode("utf8") # str in Python 3 or unicode in Python2
    elif c == "y": return s.read(int(s.readline())) # bytes in Python 3 => str in Python 2
